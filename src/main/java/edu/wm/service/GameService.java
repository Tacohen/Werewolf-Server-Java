...
public class GameService {
		...
		public Boolean canKill(Player killer, Player victim){
			if ((isNight == true) && (killer.isWereWolf()) && (victim.getLat() <= (killer.getLat()+(0.001))) && (victim.getLat() >= (killer.getLat()-(0.001))) && (victim.getLng() <= (killer.getLng()+(0.001))) && (victim.getLng() >= (killer.getLng()-(0.001)))){
